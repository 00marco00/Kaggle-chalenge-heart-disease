...
## Random forest
Notons que les algorithmes de type tree sont peu sensibles au scale des caractéristiques.On peut aussi noter que ces résultats varient bien moins que les résultats du modele_logistique et d'AdaBoost en fonction du dataset (sans la seed).
