...
modele_logistique <- glm(HeartDisease ~  Sex + ChestPainType  + Cholesterol + MaxHR + ExerciseAngina + Oldpeak + ST_Slope, data = trainData, family = binomial(link = "logit"))
#print(summary(modele_logistique))
...
modele_ada <- train(HeartDisease ~ Sex + ChestPainType + Cholesterol +  MaxHR + ExerciseAngina + Oldpeak + ST_Slope,
                    data = trainData,
                    method = "ada",
